...
import meshtastic.protobuf.leo_pb2
...
@typing.final
class TLEDatabase(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    VERSION_FIELD_NUMBER: builtins.int
    TLES_FIELD_NUMBER: builtins.int
    version: builtins.int
    """
    A version integer used to invalidate old save files when we make
    incompatible changes This integer is set at build time and is private to
    ...
    """
    @property
    def tles(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[meshtastic.protobuf.leo_pb2.TLE]:
        """
        New lite version of NodeDB to decrease memory footprint
        """
    ...
    def __init__(
        ...
        *,
        version: builtins.int = ...,
        tles: collections.abc.Iterable[meshtastic.protobuf.leo_pb2.TLE] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["tles", b"tles", "version", b"version"]) -> None: ...

global___TLEDatabase = TLEDatabase
